...
def notify_new_registration(
    ...
    """Notify admin of a new user registration with approval link."""
    name = full_name or "Non renseigne"
    approve_url = f"https://rag.marinenationale.cloud/api/auth/approve/{user_id}/{approval_token}"
    subject = f"[RAG Platform] Nouvelle demande : {email}"
    body = f"""
    <div style="font-family: Arial, sans-serif; max-width: 500px;">
        <h2 style="color: #1c1917;">Nouvelle demande d'inscription</h2>
        ...
        <p style="margin-top: 16px; font-size: 11px; color: #a8a29e; text-align: center;">
            Si vous ne souhaitez pas approuver, ignorez cet email.
        </p>
    </div>
    """
